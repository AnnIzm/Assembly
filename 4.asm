...
messageWelcome db "Tetris",0Dh ,0Ah   
               db "Control commands:",0Dh ,0Ah
               db "<- or -> - move",0Dh ,0Ah
               db "Up - rotate",0Dh ,0Ah  
               db "Esc - exit",0Dh ,0Ah
               db "Enter - start",0Dh ,0Ah,'$'
               
playField db 276 dup(00h)
figureShape db 00h, 00h, 00h, 00h  
            db 00h, 00h, 10h, 00h 
            db 10h, 10h, 10h, 00h           
            db 00h, 00h, 00h, 00h
...
newFigure proc 
    ...
    mov currentFigureX, 1
    mov currentFigureY, 1
    mov ax, ds
    mov es, ax
    mov bx, offset currentFigure
    mov cx, [bx]
